...
```sql
select count(*) from st_smart_webchat_unbundl_hm where send_flag=1;
select count(*) from st_smart_webchat_unbundl_send where send_flag=1;
select * from st_smart_webchat_unbundl_send where chg_sn='20190108017165233682187';
select * from st_smart_webchat_unbundl_hm where  chg_sn='20190108017165233682187';

select * from st_smart_webchat_unbundl_send where phone_no='15071526332';

select w.* from ST_SMART_WEBCHAT_UNBUNDL_HM w where not exists (select chg_sn from ST_SMART_WEBCHAT_UNBUNDL_SEND ) and send_flag=0
